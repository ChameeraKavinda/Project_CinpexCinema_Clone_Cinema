...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($Email) && !empty($Movie) && !empty($Count) && !empty($USD_Total)) {
        // Use prepared statements to prevent SQL injection
        $sql = "INSERT INTO booking (Email, Movie, Count, USD_Total) VALUES (?, ?, ?, ?)";
        ...
        if ($stmt) {
            // Bind parameters
            mysqli_stmt_bind_param($stmt, 'ssss', $Email, $Movie, $Count, $USD_Total);
...
<body>
  ...
  <script>
    function showMovies(groupId) {
      // Hide all movie button groups
      var groups = document.querySelectorAll('.button-group1, .button-group2, .button-group3, .button-group4, .button-group5');
 ...
 <!-- Hidden inputs to capture the selected data -->
      ...
      <input type="hidden" name="Movie" id="selectedMovieIndex" value="">
      <input type="hidden" name="Count" id="selectedCount" value="0">
...
<div class="container">
  <div class="movie-screen">
      <img src='pic/banner1.jpg' alt='screen' />
  </div>

  <div class="row-container" action="staffLog1.php" method="post">
      <div class="row">
          <div class="seat"></div>
          <div class="seat"></div>
          <div class="seat"></div>
      ...
      <h5 class='subtitle'>Cinema Seat </h5>
      <div class="row">
          <div class="seat"></div>
          <div class="seat"></div>
          <div class="seat"></div>
      ...
      <h5 class='subtitle'>Balcony </h5>

      <div class="text-wrapper">
          <p class="text">Selected Seats <span id='count' name="Count">0</span>
              <p class="text">Total Price Rs.<span id="total" name="Total">0</span></p>
      </div>
      <div class="inputBox">
...
total.textContent = selectedSeatsCount * 650;
