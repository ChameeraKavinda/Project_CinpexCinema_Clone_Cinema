...
<body>
  <div class="wrapper">
    <h2>Add Movie</h2>
    <form action="filmlog.php" method="post">
 
    <div class="input-box">
        <input type="text" name="fim_name" placeholder="Enter the film name" required>
      </div>
      
      <div class="input-box">
        <input type="text" name="des" placeholder="Enter the film Description" required>
      </div>
      <div class="input-box">
